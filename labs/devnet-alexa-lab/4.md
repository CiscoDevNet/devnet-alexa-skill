...
3. Copy the Lambda function ARN (Amazon Resource Number) from the Lambda function page on AWS. If your session at aws.amazon.com has timed out [use this link to log back in](https://725313967062.signin.aws.amazon.com/console)
